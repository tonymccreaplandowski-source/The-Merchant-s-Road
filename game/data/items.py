...
class Item:
    ...
    armor_value: int                         = 0
    armor_type: Optional[str]               = None   # "cloth" | "leather" | "mail" | None
...
ARMOR_ITEMS = [
    Item("Padded Jacket",   35,  "common",   "armor", "Light cloth padding. Better than nothing.",
         [], armor_value=3, armor_type="cloth", stat_bonuses={"Magic": 2},
    ...
    Item("Leather Vest",    65,  "common",   "armor", "Tanned hide stitched into a serviceable vest.",
         [], armor_value=6, armor_type="leather", stat_bonuses={"Stealth": 3, "Survival": 1},
    ...
    Item("Chain Hauberk",   120, "uncommon", "armor", "Interlocked iron rings. Heavy but effective.",
         [], armor_value=10, armor_type="mail", stat_bonuses={"Martial": 3, "Survival": 2, "Stealth": -3},
    ...
    Item("Scale Armour",    180, "uncommon", "armor", "Overlapping steel scales. Solid protection.",
         [], armor_value=13, armor_type="mail", stat_bonuses={"Martial": 4, "Survival": 2, "Stealth": -4},
    ...
    Item("Plate Cuirass",   350, "rare",     "armor", "Full-torso plate. Serious investment.",
         [], armor_value=18, armor_type="mail", stat_bonuses={"Martial": 6, "Survival": 2, "Stealth": -6},
